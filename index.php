...
<head>
	<meta charset="UTF-8">
	<title>pakistan agri store</title>
...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">Pak agri &copy; </h3>
		<div class="logo">
			<a href="index.php"><img src="images/logopak.png" width="150px"></a>
		</div>
		<br />
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">Pak Agri <span>kasur</span></p>
		</div>
		<div>
			<i class="fa fa-phone"></i>
			<p style="font-size:20px">0323-6828288</p>
		</div>
		<div>
			<i class="fa fa-envelope"></i>
			<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">abulhassan1431@gmail.com</a></p>
		</div>
	</div>

	<div class="footer-right">
		<p class="footer-company-about" style="color:white">
			<span style="font-size:20px"><b>About PakAgri</b></span>
